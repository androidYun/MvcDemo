...
public class UIUtils {
     ...
     * @return
     */
    public static String getFormatStr(int id, Object... strings) {
        String strformat = getResources().getString(id);
        return String.format(strformat, strings);
    }
}
