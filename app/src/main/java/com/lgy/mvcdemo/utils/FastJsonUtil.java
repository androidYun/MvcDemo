...
/**
 * Created by ${lgy} on 2018/1/2509:19
 * 邮箱1343168198@qq.com
 * 描述： describe
 * 修改内容：
 */
...
public class FastJsonUtil {
    ...
    public static final <T> T getObject(String jsontext, Class<T> clazz) {
        ...
        try {
            ...
            LogUtil.d("json字符串转换失败！" + jsontext + e.toString());
        }
        return t;
    }
    ...
    public static <T> List<T> getList(String jsonStr, Class<T> clazz) {
        ...
        try {
            ...
            LogUtil.d("json字符串转换失败！" + jsonStr + e.toString());
        }
        return list;
    }
    ...
    public static List<Map<String, Object>> listKeyMaps(String jsonString) {
        ...
        try {
            ...
            LogUtil.d("json字符串转换失败！" + jsonString + e.toString());
        }
        return list;
    }
